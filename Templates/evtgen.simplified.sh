...
xrdcp root://eosuser.cern.ch//eos/user/c/choij/public/Archive/madgraph4gpu/gridpacks/[PROC]_el8_amd64_gcc12_CMSSW_14_0_9_tarball.tar.xz $WORKDIR

tar xf [PROC]_el8_amd64_gcc12_CMSSW_14_0_9_tarball.tar.xz
...
time strace -k -T -o evtgen.log ./runcmsgrid.sh [NEVT] 1 1

# back to $EOS
xrdcp evtgen.log root://eosuser.cern.ch//eos/user/c/choij/public/Archive/madgraph4gpu/condor/[PROC].evtgen.[NEVT].log
#xrdcp evtgen.paralleized_restore_data.log root://eosuser.cern.ch//eos/user/c/choij/public/Archive/madgraph4gpu/condor/[PROC].evtgen.[NEVT].log
