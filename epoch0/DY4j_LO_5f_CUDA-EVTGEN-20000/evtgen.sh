...
# back to $EOS
xrdcp evtgen.log root://eosuser.cern.ch//eos/user/c/choij/public/Archive/madgraph4gpu/condor/DY4j_LO_5f_CUDA.evtgen.20000.log
#xrdcp evtgen.paralleized_restore_data.log root://eosuser.cern.ch//eos/user/c/choij/public/Archive/madgraph4gpu/condor/DY4j_LO_5f_CUDA.evtgen.20000.log
