...
xrdcp root://eosuser.cern.ch//eos/user/c/choij/public/Archive/madgraph4gpu/gridpacks/DY01234j_LO_5f_Simplified_FORTRAN_el8_amd64_gcc12_CMSSW_14_0_9_tarball.tar.xz $WORKDIR

tar xf DY01234j_LO_5f_Simplified_FORTRAN_el8_amd64_gcc12_CMSSW_14_0_9_tarball.tar.xz
...
rm runcmsgrid.sh
xrdcp root://eosuser.cern.ch//eos/user/c/choij/public/Archive/madgraph4gpu/patches/runcmsgrid.simplified.sh runcmsgrid.sh
chmod 755 runcmsgrid.sh
time strace -k -T -o evtgen.log ./runcmsgrid.sh 100000 1 1

# back to $EOS
xrdcp evtgen.log root://eosuser.cern.ch//eos/user/c/choij/public/Archive/madgraph4gpu/condor/DY01234j_LO_5f_Simplified_FORTRAN.evtgen.100000.log
#xrdcp evtgen.paralleized_restore_data.log root://eosuser.cern.ch//eos/user/c/choij/public/Archive/madgraph4gpu/condor/DY01234j_LO_5f_Simplified_FORTRAN.evtgen.100000.log
