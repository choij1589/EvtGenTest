...
#xrdcp root://eosuser.cern.ch//eos/user/c/choij/public/Archive/madgraph4gpu/condor/BackUps/GridpackProduction_AUG_Week3/TT0123j_CKM_LO_5f_FORTRAN_el8_amd64_gcc12_CMSSW_14_0_9_tarball.tar.xz $WORKDIR
xrdcp root://eosuser.cern.ch//eos/user/c/choij/public/Archive/madgraph4gpu/gridpacks/TT0123j_CKM_LO_5f_FORTRAN_el8_amd64_gcc12_CMSSW_14_0_9_tarball.tar.xz $WORKDIR

tar xf TT0123j_CKM_LO_5f_FORTRAN_el8_amd64_gcc12_CMSSW_14_0_9_tarball.tar.xz
...
# back to $EOS
xrdcp evtgen.log root://eosuser.cern.ch//eos/user/c/choij/public/Archive/madgraph4gpu/condor/TT0123j_CKM_LO_5f_FORTRAN.evtgen.200000.log
#xrdcp evtgen.paralleized_restore_data.log root://eosuser.cern.ch//eos/user/c/choij/public/Archive/madgraph4gpu/condor/TT0123j_CKM_LO_5f_FORTRAN.evtgen.200000.log
