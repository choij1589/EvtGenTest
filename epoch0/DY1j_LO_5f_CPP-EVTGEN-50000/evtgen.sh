...
# back to $EOS
xrdcp evtgen.log root://eosuser.cern.ch//eos/user/c/choij/public/Archive/madgraph4gpu/condor/DY1j_LO_5f_CPP.evtgen.50000.log
#xrdcp evtgen.paralleized_restore_data.log root://eosuser.cern.ch//eos/user/c/choij/public/Archive/madgraph4gpu/condor/DY1j_LO_5f_CPP.evtgen.50000.log
