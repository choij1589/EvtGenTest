...
time strace -k -T -o evtgen.log ./runcmsgrid.sh 20000 1  1 cuda

# back to $EOS
xrdcp evtgen.log root://eosuser.cern.ch//eos/user/c/choij/public/Archive/madgraph4gpu/condor/TT0123j_CKM_LO_5f.cuda.evtgen.20000.log
