...
time strace -k -T -o evtgen.log ./runcmsgrid.sh 5000 1  1 fortran

# back to $EOS
xrdcp evtgen.log root://eosuser.cern.ch//eos/user/c/choij/public/Archive/madgraph4gpu/condor/TT0123j_CKM_LO_5f.fortran.evtgen.5000.log
